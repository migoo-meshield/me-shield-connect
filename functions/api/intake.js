...
const SERVICE_MAP = {
  ...
  // Added for the NFC business-card page (connect.meshieldfinancial.com),
  // which asks a single generic "Insurance" question rather than splitting
  // into life/health/property like the main site's form. Still gated below —
  // see STATE_LICENSED_SERVICES. Migoo clarifies the specific product on
  // the follow-up call.
